...
class ManageRecordsState with _$ManageRecordsState {
  ...
  const factory ManageRecordsState.imageLoadedState(String path, String base,String type) = _ImageLoadedState;
  const factory ManageRecordsState.fileLoadedState(String path, String base,String type) = _LileLoadedState;
