...
class SlotBookServices {
  Future<void> updateTimeSlot(String uid, String date, String time, String isBooked, SlotUserModel user) async {
...
void bookAppointment({required String date,required BuildContext context,required String uid,required String selectedTime,required String isBooked,required SlotUserModel user}) async {
