...
class UpcomingSessionModel {
  ...
  factory UpcomingSessionModel.fromMap(Map<String, dynamic> map) {
    return UpcomingSessionModel(
  ...
  factory UpcomingSessionModel.fromJson(String source) => UpcomingSessionModel.fromMap(json.decode(source) as Map<String, dynamic>);

  @override
  String toString() {
    return 'UpcomingSessionModel(bookedDate: $bookedDate, cancelledAt: $cancelledAt, doctorCategory: $doctorCategory, doctorName: $doctorName, fees: $fees, profile: $profile, slotDate: $slotDate, slotTime: $slotTime, status: $status, type: $type, uid: $uid, patientName: $patientName, bookingId: $bookingId)';
  }

  @override
  bool operator ==(covariant UpcomingSessionModel other) {
